...
$breadcrumbs = ['Postes' => '/positions', $position['title'] => '/positions/' . $position['id'], 'Modifier' => ''];
?>
    ...
    <div class="col-md-8 offset-md-2">
        <div class="card card-warning">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-edit mr-1"></i> Modifier le poste
                </h3>
            </div>
            <form action="<?php echo APP_URL; ?>/positions/<?php echo (int)$position['id']; ?>" method="post">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               value="<?php echo e($old['title'] ?? $position['title'] ?? ''); ?>"
                            ...
                            <?php if (!empty($departments)): ?>
                                <?php foreach ($departments as $dept): ?>
                                    <option value="<?php echo (int)$dept['id']; ?>"
                                        <?php echo (($old['department_id'] ?? $position['department_id'] ?? '') == $dept['id']) ? 'selected' : ''; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description"
                                  ...
                                  class="form-control"
                                  rows="4"
                                  placeholder="Description du poste, missions principales..."><?php echo e($old['description'] ?? $position['description'] ?? ''); ?></textarea>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number"
                                       ...
                                       value="<?php echo e($old['salary_min'] ?? $position['salary_min'] ?? ''); ?>"
                                       min="0"
                                       step="0.01"
                                       placeholder="0.00"
                                       required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number"
                                       ...
                                       value="<?php echo e($old['salary_max'] ?? $position['salary_max'] ?? ''); ?>"
                                       min="0"
                                       step="0.01"
                                       placeholder="0.00"
                                       required>
