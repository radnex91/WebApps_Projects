...
$activeMenu = 'roles';
$breadcrumbs = ['Rôles & Permissions' => '/roles', 'Modifier' => null];
?>
    ...
    <div class="col-lg-10 offset-lg-1">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-edit mr-1"></i> Modifier le rôle : <?php echo e($role['name']); ?>
                </h3>
            </div>
            <form action="<?php echo APP_URL; ?>/roles/<?php echo e($role['id']); ?>/update" method="post">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <div class="card-header py-2">
                                    <div class="d-flex align-items-center">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            $someChecked = false;
                                            foreach ($perms as $p) {
                                                if (!empty($p['checked'])) $someChecked = true;
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input perm-checkbox"
                                                           ...
                                                           data-module="<?php echo e($module); ?>"
                                                           <?php echo !empty($perm['checked']) ? 'checked' : ''; ?>>
...
$(function () {
    ...
    <?php if (!empty($groupedPermissions)): ?>
        <?php foreach ($groupedPermissions as $module => $perms): ?>
            ...
            $checkedPerms = 0;
            foreach ($perms as $p) { if (!empty($p['checked'])) $checkedPerms++; }
            ?>
            <?php if ($checkedPerms > 0 && $checkedPerms < $totalPerms): ?>
                document.getElementById('module-<?php echo e($module); ?>').indeterminate = true;
            <?php endif; ?>
        <?php endforeach; ?>
    <?php endif; ?>
