PharmaCare — patch de mise a jour 1.2.1 -> 1.2.2
==================================================
...
APPLICATION (Linux, LAMPP) :
  1. tar -xzf pharmacare_patch_1.2.1_to_1.2.2.tar.gz
  2. cd pharmacare_patch_1.2.1_to_1.2.2
...
via APP_VERSION, desormais 1.2.2).
