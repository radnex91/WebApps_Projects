PharmaCare — patch de mise a jour 1.0.7 -> 1.0.8
==================================================
...
APPLICATION (Linux, LAMPP) :
  1. tar -xzf pharmacare_patch_1.0.7_to_1.0.8.tar.gz
  2. cd pharmacare_patch_1.0.7_to_1.0.8
...
via APP_VERSION, desormais 1.0.8).
