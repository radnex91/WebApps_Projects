PharmaCare — patch de mise a jour 1.4.3 -> 1.4.4
==================================================
...
Fichiers inclus (3) :
  ...
  - pharmacare/assets/js/app.js
  - pharmacare/config/env.php
  - pharmacare/config/licence_integrity.php  (inchange : aucun fichier couvert modifie par ce patch)
...
APPLICATION (Linux, LAMPP) :
  1. tar -xzf pharmacare_patch_1.4.3_to_1.4.4.tar.gz
  2. cd pharmacare_patch_1.4.3_to_1.4.4
...
via APP_VERSION, desormais 1.4.4).
