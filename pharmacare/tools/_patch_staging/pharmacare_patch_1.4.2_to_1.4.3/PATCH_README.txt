PharmaCare — patch de mise a jour 1.4.2 -> 1.4.3
==================================================
...
APPLICATION (Linux, LAMPP) :
  1. tar -xzf pharmacare_patch_1.4.2_to_1.4.3.tar.gz
  2. cd pharmacare_patch_1.4.2_to_1.4.3
...
via APP_VERSION, desormais 1.4.3).
