PharmaCare — patch de mise a jour 1.0.7 -> 1.0.9
==================================================
...
Fichiers inclus (5) :
  ...
  - pharmacare/assets/css/style.css
  - pharmacare/modules/commandes.php
  - pharmacare/modules/produits.php
  - pharmacare/modules/utilisateurs.php
...
APPLICATION (Linux, LAMPP) :
  1. tar -xzf pharmacare_patch_1.0.7_to_1.0.9.tar.gz
  2. cd pharmacare_patch_1.0.7_to_1.0.9
...
via APP_VERSION, desormais 1.0.9).
