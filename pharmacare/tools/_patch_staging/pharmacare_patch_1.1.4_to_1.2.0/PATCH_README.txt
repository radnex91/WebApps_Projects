PharmaCare — patch de mise a jour 1.1.4 -> 1.2.0
==================================================
...
Fichiers inclus (9) :
  ...
  - pharmacare/config/assistant.php
  - pharmacare/modules/assistant.php
  - pharmacare/modules/parametres.php
  - pharmacare/includes/layout.php
  - pharmacare/includes/url.php
  - pharmacare/.htaccess
...
APPLICATION (Linux, LAMPP) :
  1. tar -xzf pharmacare_patch_1.1.4_to_1.2.0.tar.gz
  2. cd pharmacare_patch_1.1.4_to_1.2.0
...
via APP_VERSION, desormais 1.2.0).
