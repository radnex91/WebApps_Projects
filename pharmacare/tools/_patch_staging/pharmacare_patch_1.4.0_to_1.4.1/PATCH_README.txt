PharmaCare — patch de mise a jour 1.4.0 -> 1.4.1
==================================================
...
APPLICATION (Linux, LAMPP) :
  1. tar -xzf pharmacare_patch_1.4.0_to_1.4.1.tar.gz
  2. cd pharmacare_patch_1.4.0_to_1.4.1
...
via APP_VERSION, desormais 1.4.1).
