...
<div class="modal fade" id="addModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    <div class="modal-header"><h5 class="modal-title">Nouvelle agence</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
    ...
    <div class="modal-body">
        <div class="mb-3"><label class="form-label">Code agence <span class="text-danger">*</span></label><input type="text" name="codeagence" class="form-control" required placeholder="DAN-002"></div>
        <div class="mb-3"><label class="form-label">Nom agence <span class="text-danger">*</span></label><input type="text" name="nomagence" class="form-control" required></div>
    </div>
...
<div class="modal fade" id="editModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    <div class="modal-header"><h5 class="modal-title">Modifier agence</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
    ...
    <div class="modal-body">
        <div class="mb-3"><label class="form-label">Code agence <span class="text-danger">*</span></label><input type="text" name="codeagence" id="edit_codeagence" class="form-control" required></div>
        <div class="mb-3"><label class="form-label">Nom agence <span class="text-danger">*</span></label><input type="text" name="nomagence" id="edit_nomagence" class="form-control" required></div>
