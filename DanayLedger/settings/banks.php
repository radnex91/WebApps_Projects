...
<div class="modal fade" id="addModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    <div class="modal-header"><h5 class="modal-title">Nouvelle banque</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
    ...
    <div class="modal-body">
        <div class="mb-3"><label class="form-label">Code banque <span class="text-danger">*</span></label><input type="text" name="codeBank" class="form-control" required placeholder="BICIGUI"></div>
        <div class="mb-3"><label class="form-label">Nom banque <span class="text-danger">*</span></label><input type="text" name="nombank" class="form-control" required></div>
    </div>
...
<div class="modal fade" id="editModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    ...
    <div class="modal-body">
        <div class="mb-3"><label class="form-label">Code banque <span class="text-danger">*</span></label><input type="text" name="codeBank" id="edit_codeBank" class="form-control" required></div>
        <div class="mb-3"><label class="form-label">Nom banque <span class="text-danger">*</span></label><input type="text" name="nombank" id="edit_nombank" class="form-control" required></div>
