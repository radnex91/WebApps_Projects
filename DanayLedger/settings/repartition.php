...
<div class="modal fade" id="addModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    <div class="modal-header"><h5 class="modal-title">Nouvelle clé de répartition</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
    ...
    <div class="modal-body">
        <div class="mb-3"><label class="form-label">Propriétaire <span class="text-danger">*</span></label><select name="proprietaire_id" class="form-select" required><option value="">-- Sélectionner --</option><?php foreach($proprietaires as $p): ?><option value="<?php echo $p['id']; ?>"><?php echo e($p['nomProprio']); ?> (<?php echo e($p['codeproprio']); ?>)</option><?php endforeach; ?></select></div>
        <div class="mb-3"><label class="form-label">Part 1 (%) <span class="text-danger">*</span></label><input type="number" name="part1" class="form-control" min="0" max="100" step="0.01" required></div>
        <div class="mb-3"><label class="form-label">Part 2 (%) <span class="text-danger">*</span></label><input type="number" name="part2" class="form-control" min="0" max="100" step="0.01" required></div>
    </div>
...
<div class="modal fade" id="editModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    <div class="modal-header"><h5 class="modal-title">Modifier clé de répartition</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
    ...
    <div class="modal-body">
        ...
        <div class="mb-3"><label class="form-label">Part 1 (%) <span class="text-danger">*</span></label><input type="number" name="part1" id="edit_part1" class="form-control" min="0" max="100" step="0.01" required></div>
        <div class="mb-3"><label class="form-label">Part 2 (%) <span class="text-danger">*</span></label><input type="number" name="part2" id="edit_part2" class="form-control" min="0" max="100" step="0.01" required></div>
    </div>
