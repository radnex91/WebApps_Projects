...
CREATE TABLE products (
    ...
    is_active TINYINT(1) NOT NULL DEFAULT 1,
    is_carcass TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Whole/half animal product, source for breakdown',
...
CREATE TABLE stock_movements (
    ...
    movement_type ENUM('purchase','sale','adjustment','waste','return','breakdown') NOT NULL,
...
-- =============================================
-- BREAKDOWNS (Découpe - Meat Cutting)
-- =============================================
...
-- Carcass products (source for breakdown/découpe)
