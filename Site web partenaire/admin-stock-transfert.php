...
<head>
  ...
  <title>Administration — Transfert de stock</title>
...
<body data-admin-page="stock-transfert">
  <header>
  ...
  <main class="admin-dashboard">
    ...
    <section class="admin-main">
      <section class="admin-section section-stock">
        ...
        <p class="section-hint">Transférez du stock d'un rayon à un autre. Le produit doit avoir un stock suffisant dans le rayon source.</p>
        ...
        <form id="form-stock" class="form-stock card-admin">
          ...
          <div class="form-row form-row-stock">
            <div class="form-group">
              <label for="stock-rayon">Rayon source</label>
              <select id="stock-rayon" required></select>
            </div>
            <div class="form-group">
              <label for="stock-rayon-dest">Rayon destination</label>
              <select id="stock-rayon-dest" required></select>
            </div>
          </div>
          <div class="form-row form-row-stock">
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" id="stock-comment" maxlength="500" placeholder="Motif du transfert…">
            </div>
          </div>
          <button type="submit" class="btn btn-primary" id="stock-submit">Effectuer le transfert</button>
        </form>
        <h3 class="stock-subtitle">Derniers transferts</h3>
