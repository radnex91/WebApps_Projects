...
<head>
  ...
  <title>Administration — Sortie de stock</title>
...
<body data-admin-page="stock-sortie">
  <header>
  ...
  <main class="admin-dashboard">
    ...
    <section class="admin-main">
      <section class="admin-section section-stock">
        ...
        <p class="section-hint"><strong>Sortie</strong> (retrait interne) ou <strong>Vente</strong> (sortie tracée). Le stock ne peut pas être négatif.</p>
        ...
        <form id="form-stock" class="form-stock card-admin">
          ...
          <div class="form-group">
            ...
            <input type="text" id="stock-comment" maxlength="500" placeholder="Réf. bon, client, motif…">
          </div>
          <button type="submit" class="btn btn-primary" id="stock-submit">Enregistrer la sortie</button>
        </form>
        <h3 class="stock-subtitle">Dernières sorties &amp; ventes</h3>
